    ...
    return (
        ...
        />
            ...
            <div className={styles['choice-wrapper']}>
                <ChoiceQuiz onClick={() => setQuestionAnswer(genAnswer(thisQuestionObject['choices'][0]['field']))} mt={24} size={24} text = {thisQuestionObject['choices'][0]['text']}></ChoiceQuiz>
                <ChoiceQuiz onClick={() => setQuestionAnswer(genAnswer(thisQuestionObject['choices'][1]['field']))} mt={24} size={24} text = {thisQuestionObject['choices'][1]['text']}></ChoiceQuiz>
                <ChoiceQuiz onClick={() => setQuestionAnswer(genAnswer(thisQuestionObject['choices'][2]['field']))} mt={24} size={24} text = {thisQuestionObject['choices'][2]['text']}></ChoiceQuiz>
                <ChoiceQuiz onClick={() => setQuestionAnswer(genAnswer(thisQuestionObject['choices'][3]['field']))} mt={24} size={24} text = {thisQuestionObject['choices'][3]['text']}></ChoiceQuiz>
